    ...
    <footer className="bg-gray-900 text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-gray-400 mb-4 max-w-md">
              Connecting alumni with students through opportunities, mentorship, and scholarship support. 
              Building stronger bonds and creating pathways to success.
            </p>
          ...
          <div>
            ...
            <div className="space-y-2 text-gray-400">
              <p>📧 info@alumniconnect.com</p>
              <p>📞 +1 (555) 123-4567</p>
              <p>📍 University Campus, City, State</p>
            </div>
          </div>
        </div>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 text-center text-gray-400">
          <p>&copy; 2024 Alumni Connect Platform. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
